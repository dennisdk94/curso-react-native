...
export default class App extends Component {
  state = { ...inicialState }; //criando uma cópia do estado inicial

  //Função para adicionar um dígito
  addDigit = n => {
    ...
    this.setState({ displayValue, clearDisplay: false }); //Atualizando os valores do estado
  ...
  //Função para zerar os campos e display
  clearMemory = () => {
